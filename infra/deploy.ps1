...
Write-Host ""
Write-Host "Smoke check:  curl.exe $ApiUrl/health ; curl.exe $SandboxUrl/health"
Write-Host "An unauthenticated call to $AgentsUrl/health should return 403 - that's the lock."
